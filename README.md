...
Copy code
python3 main.py
Follow the prompts to input the target PPM and water level for your system.

The script will continuously monitor the hydroponic system and make adjustments as necessary.
